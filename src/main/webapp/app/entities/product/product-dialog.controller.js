(function() {
    ...
    ProductDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Product', 'ProductDescription', 'Picture', 'Category', 'Supplier', 'ShopingCart', 'Promotion'];

    function ProductDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Product, ProductDescription, Picture, Category, Supplier, ShopingCart, Promotion) {
        var vm = this;
