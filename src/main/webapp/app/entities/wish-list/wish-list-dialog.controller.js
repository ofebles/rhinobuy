(function() {
    ...
    WishListDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'WishList', 'Customer', 'Product'];

    function WishListDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, WishList, Customer, Product) {
        var vm = this;
