...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "returnAuthorization":null, "name":"SAMPLE_TEXT", "price":null, "size":"SAMPLE_TEXT", "color":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "otherDetails":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
